...
def set_save_name(name):
    ...
    IMG_SAVE_DIR = get_dir(os.path.join(SAVE_DIR, SAVE_NAME))
...
IMG_SAVE_FREQ   = 900   # how often to save generated images, in # steps
...
LRATE_G = 0.00025  # Value in paper is 0.04
